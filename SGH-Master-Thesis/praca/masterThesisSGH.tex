...
\begin{figure}
  ...
  cenę opcji wg różnych metodologii w modelu Hestona.}\label{fig:currencyRisk}
\end{figure} 
...
W tym punkcie podana zostanie implementacja schematu Andersena. Zostały podane dwa
...
Poniżej podajemy implementację funkcji wyliczającej poprawkę martyngałową 
...
\subsection{Wycena opcji w modelu Hestona przy pomocy wzoru zamkniętego}
