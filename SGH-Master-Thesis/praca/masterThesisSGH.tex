...
\begin{algorithmic}[1]
  ...
  \State Wyznacz $\Psi = \frac{s^2}{m^2}$ i wyznacz $f_{\mu}(\Psi)$ oraz $f_{\sigma}(\Psi)$ 
  ...
  \State \hspace{\algorithmicindent} oblicz $Z_V = \Psi^{-1}(U_V)$
...
\begin{aligned}
\label{eq:xt}
\ln S(t + \Delta) = & \ln S(t)  + \frac{\rho}{\epsilon} (v(t + \Delta)  - v(t) - \kappa \theta \Delta) + \\
