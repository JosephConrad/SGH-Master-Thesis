...
\caption{Pilk nagłówkowy dla klasy \textit{Heston}}
\end{listing} 
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/HestonCPP/src/main/cpp/heston/header/HestonMC.h}
\caption{Pilk nagłówkowy dla klasy definiującej interfejs symulacji Monte Carlo}
\end{listing} 
...
\caption{Metoda \textit{simulateVolPath} z jednoczsnym wyznaczeniem poprawki martyngałowej}
\end{listing}  
...
Seckja ta przedstawia kod źródłowy dla opisanej w rozdziale, implementacji wzoru zamkniętego
na wycenę opcji. 
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
