...
If $X_1, ..., X_n ~P$ iid  wtedy
jest srenia z proby 
\begin{equation}
  
\end{equation}
Wtedy mi jest podstawowym estymatorem Monte Carlo $Ef(x)$. Inaczej mówiąc, aproksymujemy prawdziwą wartość warotści oczekiwanej \textbf{średnią z próby} \textit{ang. sample mean}.
