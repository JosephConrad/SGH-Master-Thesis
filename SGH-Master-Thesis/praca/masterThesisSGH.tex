...
Powyższe równanie przedstawie dokładny wzór na wartość aktywa 
...
\end{equation}
Poniższy kod przedstawia implementację tego algorytmu \cite{JoshiDesignPatterns}:
...
\begin{figure}
  \centering  
  \includegraphics[width=1.00\textwidth]{../diagramms/HestonDiagramm.pdf}
...
% integral for "P1" (effectively the delta) and P2 (effectively the risk-neutral probability that spot exceed strike at expiry, see Mikhailov+Nögel)
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/src/main/cpp/heston/header/HestonEuler.h}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/src/main/cpp/heston/header/HestonAndersen.h}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/src/main/cpp/heston/header/Heston.h}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/src/main/cpp/heston/src/HestonAndersen.cpp}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/src/main/cpp/heston/src/Heston.cpp}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/src/main/cpp/heston/src/HestonEuler.cpp}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/src/main/cpp/random/PolarGenerator.h}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/src/main/cpp/random/PolarGenerator.cpp}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/src/main/cpp/bs/MCBlackScholes.cpp}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/src/main/cpp/bs/MCBlackScholes.h}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
