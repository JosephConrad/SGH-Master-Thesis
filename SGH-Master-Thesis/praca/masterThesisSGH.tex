...
\begin{aligned}
\label{eq:xt}
\ln S(t + \Delta) = & \ln S(t)  + \frac{\rho}{\varepsilon} (v(t + \Delta)  - v(t) - \kappa \theta \Delta) + \\
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/HestonModel/header/HestonEuler.h}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/HestonModel/header/HestonAndersen.h}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/HestonModel/header/Heston.h}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/HestonModel/src/HestonAndersen.cpp}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/HestonModel/src/Heston.cpp}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
...
\begin{listing}[H]
\inputminted[mathescape, linenos, numbersep=5pt, bgcolor=bg, frame=lines, framesep=2mm]{cpp}
{../src/heston/HestonModel/src/HestonEuler.cpp}
\caption{Metoda Monte Carlo dla modelu Hestona  \cite{HallsMoore}}
\label{lst:MCHeston}
\end{listing} 
