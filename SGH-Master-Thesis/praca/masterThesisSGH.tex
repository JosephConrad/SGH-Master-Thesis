...
Odpowiada on za przejście ze świata deterministycznego, opisywanego przez równania różniczkowe
zwyczajne, do świata losowego, które opisują stochastyczne równania różniczkowe.
...
przypadku modelu Hestona współczynnik zmienności opisany jest równaniem:
 \textbf{model Coxa-Ingersolla-Rossa} 
...
Zmienność jest zawsze wartością większą od zera, co wynika wprost z jej definicji.
...
W części empirycznej pracy (rozdział \ref{r:sp}) zostanie przedstawiona symulacja 
kształtowania się trajektorii aktywa bazowego (indeksu S\&P) w zależności od czasu do wygaśnięcia. 
