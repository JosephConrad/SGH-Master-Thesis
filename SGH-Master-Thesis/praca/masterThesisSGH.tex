...
\section{Wyznaczenie wartośći wartości opcji}
...
W nieniejszym wprowadzającym rozdziale została przedstawiona symulacja Monte Carlo 
...
{listings/sa.cpp}
\caption{Algorytm symulowanego wyżarzani }
