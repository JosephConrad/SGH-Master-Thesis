...
giełdowe.
% subsection opcje_na_akcje_i_indeksy_gie_dowe (end)
...
% subsection opcje_na_rynku_walutowym (end)

\subsection{Market } % (fold)
\label{sub:produkty_strukturyzowane}

% subsection produkty_strukturyzowane (end)
...
% subsection rachunkowosc_sprawozdawcza (end)
