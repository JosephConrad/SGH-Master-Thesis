function surface = VolatilitySurface(S0, r, T, K, CallPrice)
%**************************************************************************
...
xlabel('Time to Matutity $T$','Fontsize',10,'FontWeight','Bold','interpreter','latex');
ylabel('Moneyness M','Fontsize',10,'FontWeight','Bold','interpreter','latex');
zlabel('Implied Volatility $\sigma(T,M)$','Fontsize',10,'FontWeight','Bold','interpreter','latex');
