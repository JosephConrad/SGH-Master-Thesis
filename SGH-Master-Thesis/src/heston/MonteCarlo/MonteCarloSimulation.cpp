...
float MonteCarloSimulation::simulateHeston(std::vector<float> params) {
    ...
    double rho = params[0];   // Correlation of asset and volatility
    double kappa = params[1];  // Mean-reversion rate
    double theta = params[2];  // Long run average volatility
    double xi = params[3];
...
void MonteCarloSimulation::generate_normal_correlation_paths(double rho,
